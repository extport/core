 ...
 *
 * Syncs the .github/ directory and root-level template files from mirror-template
...
const ORG = 'extport';
const TEMPLATE_REPO = 'mirror-template';
const GITHUB_DIR = '.github';
const BRANCH_NAME = 'chore/sync-template-github';
const PR_TITLE = 'chore: sync template files from mirror-template';
const PR_BODY = `This PR updates template-managed files to match the latest version from \`extport/mirror-template\`.

This is an automated PR created by the [sync-template-github](https://github.com/extport/core/actions/workflows/sync-template-github.yml) workflow.`;

// Root-level files from the template that should be synced to all mirrors
const ROOT_FILES = ['.extport.schema.json'];
