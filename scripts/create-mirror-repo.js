 ...
 *
 * Creates a new mirror repo under extport org from the mirror-template,
 * then populates .extport.json with the upstream config.
 *
 * Required env vars:
...
export async function main() {
    ...
    console.log(`Creating ${ORG}/${extName} from template...`);
    ...
    // Get the current .extport.json to find its SHA (needed for update)
    ...
    console.log('✓ .extport.json configured');
