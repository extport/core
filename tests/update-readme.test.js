...
describe('update-readme', () => {
    describe('generateTable', () => {
        it('generates markdown table with extensions', () => {
            ...
            assert.ok(table.includes('[extport/redis]'));
            assert.ok(table.includes('https://packagist.org/packages/extport/redis'));
        });
        ...
        it('generates table with multiple extensions', () => {
            const extensions = [
                ...
                },
                {
                    ...
                    'mirror-repo': 'extport/imagick',
                    'packagist-name': 'extport/imagick',
                },
            ];
            const table = generateTable(extensions);
